...
class ProductCategoryRepository extends EntityRepository
{
    ...
    public function getProductCategoryQueryBuilder($category = null, $recursive = false)
    {
        $queryBuilder = $this->getEntityManager()->createQueryBuilder()
                ->select("hpc, p")
                ->from("CoreGoogleBundle:ProductCategory", "hpc")
    ...
    public function getGoogleCategoriesArray($productIds = array(), $locale = null) 
    {
        $qb = $this->getProductCategoryQueryBuilder()
            ->select("hpc.googleCategory as google, p.id as product");
        if (!empty($productIds)) {
