...
class CategoryCategoryRepository extends EntityRepository
{
    ...
    public function getCategoryCategoryQueryBuilder()
    {
        $queryBuilder = $this->getEntityManager()->createQueryBuilder()
                ->select("hcc, c")
                ->from("CoreGoogleBundle:CategoryCategory", "hcc")
    ...
    public function getGoogleCategoriesArray($categoryIds = array(), $locale = null) 
    {
        $qb = $this->getCategoryCategoryQueryBuilder()
            ->select("hcc.googleCategory as google, c.id as category");
